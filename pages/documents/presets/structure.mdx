...
<details>
  ...
  <img src="/images/examples/ac_documents/medical-report.png" alt="Example document (medical report)" />
</details>

```lua copy filename="ac_documents/editable/presets.lua"
['MedicalReport'] = {
...
<details>
  <summary>Example document</summary>
  <img src='/images/examples/ac_documents/appointment-request.png' alt='Example document (appointment request)' />
</details>
